...
public class RustFsStorageService {
    ...
    private final com.onerag.document.service.RustFsProperties properties;
    ...
    public String uploadFile(InputStream inputStream, String filename, String contentType, Map<String, String> metadata) {
        try {
            ...
            log.info("开始上传文件到 RustFS: bucket={}, objectKey={}, size={} bytes", 
                bucket, objectKey, inputStream.available());
            ...
            if (metadata != null && !metadata.isEmpty()) {
                metadata.forEach(putObjBuilder::metadata);
            }
